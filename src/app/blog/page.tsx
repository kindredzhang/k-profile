          ...
          {filteredPosts.length > 0 ? (
                ...
                <article key={post.id} className="group">
                  ...
                  >
                    <div className="flex-1 min-w-0">
                      <h3 className="text-sm md:text-base font-medium text-foreground group-hover:text-primary transition-colors truncate">
                        {post.title}
                      </h3>
                    </div>
            ...
            <div className="text-center py-12">
              <div className="w-12 h-12 mx-auto mb-3 bg-muted/20 rounded-full flex items-center justify-center">
                <BookIcon width="20" height="20" className="text-muted-foreground" />
                </div>
